...
#rsync -avh rylansch@openmind-dtn.mit.edu:/om2/user/rylansch/FieteLab-RIBP/01_prior/results/mse_analytical_vs_monte_carlo.png 01_prior/results/
...
#rsync -avh --exclude='*.joblib' rylansch@openmind7.mit.edu:/om2/user/rylansch/FieteLab-RIBP/02_linear_gaussian/results/ 02_linear_gaussian/results/
